...
- Android WatchPath: keep goal and 5/10/20-minute choices compact inside Video Subs; show the route before playback, disclose skipped ranges on demand, and place the active Previous/Next/Undo/Stop strip immediately above speed controls.
